...
public class LaidOffStaffModel extends AbstractModel {
	...
	// Constructors
	// ================================================================================
	public LaidOffStaffModel(int id, String degree, String firstName, String lastName) {
		super(id);
	...
	public LaidOffStaffModel(String degree, String firstName, String lastName) {
		super();
		this.degree = new SimpleStringProperty(degree);
		this.first = new SimpleStringProperty(firstName);
		this.lastName = new SimpleStringProperty(lastName);
